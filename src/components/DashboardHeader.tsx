...
export function DashboardHeader({ title, subtitle, extra }: DashboardHeaderProps) {
    return (
        <motion.div
        ...
        >
            ...
            <div className="relative z-10 space-y-2">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-[#6FA65A] uppercase tracking-[0.4em]">لوحة التحكم الاحترافية</span>
                </div>
            ...
            <div className="flex items-center gap-4 md:gap-6 relative z-10 w-full md:w-auto justify-between md:justify-start">
                {extra}
                <button className="w-12 h-12 md:w-16 md:h-16 bg-white/5 hover:bg-[#6FA65A] text-white rounded-2xl md:rounded-[2rem] transition-all duration-500 border border-white/10 flex items-center justify-center group shadow-2xl active:scale-90">
