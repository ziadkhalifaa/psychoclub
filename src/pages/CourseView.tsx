          ...
          <div className="space-y-6 md:space-y-8 text-white">
            ...
            <div className="flex items-center gap-4 md:gap-5 pt-6 border-t border-white/5">
              ...
              <div>
                ...
                <div className="font-black text-lg md:text-xl">{course.publisher?.name || course.instructor?.user?.name || 'Admin'}</div>
                <div className="text-slate-500 text-[10px] md:text-xs font-bold">{course.instructor?.title || (course.publisher ? 'الناشر المعتمد' : '')}</div>
              </div>
            </div>
          </div>
